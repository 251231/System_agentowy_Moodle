    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ color: 'var(--fg)', margin: 0 }}>{isLogin ? 'Zaloguj się' : 'Stwórz konto'}</h2>
          <p style={{ color: 'var(--dim)', marginTop: '0.5rem', fontSize: '0.9rem' }}>
            System Agentowy Moodle
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          >
            {loading ? <div className="spinner" /> : (isLogin ? 'Zaloguj się' : 'Zarejestruj się')}
          </button>
        </form>

        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem', color: 'var(--dim)' }}>
